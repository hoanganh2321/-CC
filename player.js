    ...
    client.riffy.on("trackStart", async (player, track) => {
        ...
        collector.on('collect', async i => {
            ...
            if (i.customId === 'loopQueue') {
                ...
                const skipEmbed = new EmbedBuilder()
                    ...
                    .setTitle("**Người Nghe Đã Bỏ Qua Bài Khác**")
                    .setTimestamp();
                ...
                const loopEmbed = new EmbedBuilder()
                    ...
                    for (let i = 0; i < pages.length; i++) {
                        ...
                        const queueEmbed = new EmbedBuilder()
                            .setColor("#0099ff")
                            .setTitle(`Danh sách (Page ${i + 1}/${pages.length})`)
                    ...
                    const queueEmbed = new EmbedBuilder()
                        .setColor("#0099ff")
                        .setAuthor({
                            name: 'Xóa Danh Sách Phát',
                            iconURL: 'https://cdn.discordapp.com/attachments/1230824451990622299/1230836684774576168/7762-verified-blue.gif?ex=6638b97d&is=663767fd&hm=021725868cbbc66f35d2b980585489f93e9fd366aa57640732dc49e7da9a80ee&',
                            url: 'https://discord.gg/VZK8nJ3MJX'
                        })
                        .setDescription('**Xóa Danh Sách Phát Thành Công**');
        ...
        client.riffy.on("queueEnd", async (player) => {
            ...
            if (autoplay) {
                ...
                const queueEmbed = new EmbedBuilder()
                    .setColor("#0099ff")
                    .setDescription('**Bài Hát Đã Hết | Bot Sẽ Tự Động Ngắt Kết Nối Khỏi Phòng ! **');
